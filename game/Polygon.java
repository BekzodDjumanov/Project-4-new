...
class Polygon {
  ...
  /**
   * Constructs a polygon from an array of points, a position offset, and a rotation.
   *
  ...
  /**
   * Returns the array of points after applying rotation and position offset.
   *
  ...
  /**
   * Checks if a given point is inside this polygon
   *
